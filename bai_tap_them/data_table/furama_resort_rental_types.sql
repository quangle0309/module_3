...
CREATE TABLE `rental_types` (
  ...
  `name_rental_type` varchar(45) DEFAULT NULL,
...
INSERT INTO `rental_types` VALUES (1,'Thuê Theo Năm',10000),(2,'Thuê Theo Tháng',1000),(3,'Thuê Theo Ngày',100),(4,'Thuê Theo Giờ',10);
