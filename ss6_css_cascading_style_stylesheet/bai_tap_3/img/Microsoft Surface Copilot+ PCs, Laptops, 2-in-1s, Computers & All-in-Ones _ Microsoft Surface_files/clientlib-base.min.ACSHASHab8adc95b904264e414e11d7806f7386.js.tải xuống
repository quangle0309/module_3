...
`;let yt=class extends ht{constructor(){super(...arguments),this.pid="",this.sku="",this.isM365="fasle",this.locale="en-us",this.env="prod",this._errorText="Price unavailable",this.productTask=new $t(this,{task:async([t,e,s,i],{signal:r})=>{if(!t)throw new Error("Product id is required");(s=s?.toLowerCase()||document.documentElement.lang?.toLowerCase()||"en-us").length<5&&(s="en-us"),i=i||(location.hostname.includes("www.")||location.hostname.includes("adobeprod")?"prod":"ppe");const o=await fetch(`https://www${"prod"===i?"":"ppe"}.microsoft.com/msstoreapi${"prod"===i?"prod":"ppe"}/api/productCompare?locale=${s}&productIds=${t}&environment=`+("prod"===i?"prod":"ppe")+("false"===e?"":"&isM365Page=true"),{signal:r});if(!o)throw new Error("DynamicPrice fetch no response");if(!o.ok)throw new Error(`DynamicPrice fetch bad response: ${o}`);const n=o.json();if(!n)throw new Error("DynamicPrice fetch: data is empty");return n},args:()=>[this.pid,this.isM365,this.locale,this.env]}),this.extract=t=>{const e=t?.products?.find((t=>t.id===this.pid));if(!e)throw new Error("(Product not found)");const s=this.sku?(e.skuInfo?.[this.sku.toUpperCase()]||e.skuInfo?.[this.sku.toLowerCase()])?.price:Object.values(e.skuInfo||{}).map((t=>t.price)).reduce(((t,e)=>t&&t.currentValue<e?.currentValue?t:e),void 0);if(!s)throw new Error("(Price not found)");return s?.recurrencePrice||s?.currentPrice||this._errorText}}render(){return this.productTask.render({pending:()=>W`<span class="ellipsis-loading"
          >$<span> • </span><span> • </span><span> • </span><span> • </span
          ><span> • </span><span> • </span></span
        >`,complete:t=>{let e="";try{e=this.extract(t)}catch(t){e=`(${this._errorText})`}return W`${e}`},error:t=>(console.log(t),W`(${this._errorText})`)})}connectedCallback(){super.connectedCallback(),this._getFromHelper()}_getFromHelper(){const t=`${this.pid}-${this.sku}${this.isM365&&"false"!=this.isM365?"-ism365":""}`,e=this.shadowRoot?.host.querySelector(`[data-pid-sku='${t}']`);e&&(this._errorText=e?.errorText||"Price unavailable")}};var mt;return yt.styles=_t,s([pt({attribute:"pid"})],yt.prototype,"pid",void 0),s([pt({attribute:"sku"})],yt.prototype,"sku",void 0),s([pt({attribute:"ism365"})],yt.prototype,"isM365",void 0),s([pt({attribute:"locale"})],yt.prototype,"locale",void 0),s([pt({attribute:"env"})],yt.prototype,"env",void 0),s([pt({state:!0,attribute:!1})],yt.prototype,"_errorText",void 0),yt=s([(mt="dynamic-price",(t,e)=>{customElements.get(mt)?console.warn(`${mt} is already defined.`):void 0!==e?e.addInitializer((()=>{customElements.define(mt,t)})):customElements.define(mt,t)})],yt),e})(),t.exports=e()}},e={};function s(i){var r=e[i];if(void 0!==r)return r.exports;var o=e[i]={exports:{}};return t[i](o,o.exports,s),o.exports}s.n=t=>{var e=t&&t.__esModule?()=>t.default:()=>t;return s.d(e,{a:e}),e},s.d=(t,e)=>{for(var i in e)s.o(e,i)&&!s.o(t,i)&&Object.defineProperty(t,i,{enumerable:!0,get:e[i]})},s.o=(t,e)=>Object.prototype.hasOwnProperty.call(t,e),(()=>{"use strict";s(391)})()})();
