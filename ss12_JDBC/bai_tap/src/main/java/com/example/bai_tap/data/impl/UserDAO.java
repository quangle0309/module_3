package com.example.bai_tap.data.impl;

import com.example.bai_tap.data.IUserDAO;
...
public class UserDAO implements IUserDAO {
    ...
    private String jdbcPassword = "848664";
    ...
    public List<User> searchByName(String keyword) throws SQLException {
        ...
        try (Connection connection = getConnection(); PreparedStatement statement = connection.prepareStatement("select * from users where name like ?");) {
